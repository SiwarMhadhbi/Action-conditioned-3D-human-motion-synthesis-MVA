...
def do_epochs(model, datasets, parameters, optimizer, writer,start_epoch):
    ...
    with open(logpath, "w") as logfile:
        for epoch in range(start_epoch, parameters["num_epochs"]+1):
...
if __name__ == '__main__':
    ...
    # ckp_path = "/content/drive/MyDrive/Project_Rec_Vis/data/ntu13/PostPros_output_PARE/checkpoint_0900.pth"
    # model.load_state_dict(torch.load(ckp_path))
    do_epochs(model, datasets, parameters, optimizer, writer,1)
