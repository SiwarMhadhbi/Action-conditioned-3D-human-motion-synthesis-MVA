...
class NTU13(Dataset):
    ...
    def __init__(self, datapath='/content/drive/MyDrive/Project_Rec_Vis/data/ntu13/PostPros_output_PARE', **kwargs):
        self.datapath = datapath
        super().__init__(**kwargs)
        
        motion_desc_file = "ntu_pare_list.txt"
    ...
    def _load_rotvec(self, ind, frame_ix):
        ...
        pose1 = pose[:,:,:,0]
        pose = pose1.reshape(pose.shape[0], 24, 3)
        return pose
